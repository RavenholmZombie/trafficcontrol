...
import com.clussmanproductions.trafficcontrol.tileentity.SafetranType1TileEntity;
import com.clussmanproductions.trafficcontrol.tileentity.TeardropBellTileEntity;
...
public class BlockSafetranType1 extends Block implements ITileEntityProvider
{
	...
	public BlockSafetranType1()
	{
		...
		setUnlocalizedName(ModTrafficControl.MODID + ".safetran_type_1");
		setHardness(2f);
